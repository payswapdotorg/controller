...
class RealRepositoryTests(unittest.TestCase):
    def test_real_repository_authority_validates(self) -> None:
        ...
        self.assertEqual(program.active_work_item, "CTRL-002")
        ...
        self.assertEqual(program.completed, ("CTRL-001", "CTRL-002"))
    ...
    def test_real_work_item_status_parses(self) -> None:
        self.assertIs(load_work_item_status(REPO_ROOT, "CTRL-002"), LifecycleState.COMPLETE)
