...
- **PR:** implementation PR not yet opened; branch `ctrl-010-dogfood` delivered from the exact governance activation base `3a53cff188dbc9ff1bdb0429df61f67ca8c71055` plus the absorbed dashboard-only dispatch marker `42ee91790c2a844b16b3790b4ccdec2b7630af3a`; the PR opens immediately after this dashboard update
...
- **current implementation action:** the implementation PR is being opened on the exact delivered head; Architect review of the composed dogfood evidence (AC1–AC9) follows
