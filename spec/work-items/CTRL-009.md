...
- Reconciliation checkpoint: this work-order record and machine state were updated from the observed merge in the reconciliation PR; no implementation semantics are changed by reconciliation.
