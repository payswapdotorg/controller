...
CTRL-001 through CTRL-007 are complete and reconciled: accepted and merged via PR #1, PR #4, PR #7, PR #11, PR #14, PR #17, and PR #20 and recorded in machine state `completed`. **CTRL-008 remains planned and is not yet defined or eligible.** Later items remain planned until their predecessor is complete and machine state is reconciled. No worker may begin a planned item merely because its code appears useful.
