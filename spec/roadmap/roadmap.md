...
CTRL-001, CTRL-002, CTRL-003, CTRL-004, CTRL-005, and CTRL-006 are complete and reconciled: accepted and merged via PR #1, PR #4, PR #7, PR #11, PR #14, and PR #17 and recorded in machine state `completed`. **CTRL-007 remains planned and is not yet defined or eligible.** Later items remain planned until their predecessor is complete and machine state is reconciled. No worker may begin a planned item merely because its code appears useful.
